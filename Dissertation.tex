...
\etitle{State-wise Safety in Autonomous Driving via Lagrangian-based Constrained Reinforcement Learning}
...
% Insert \titlebreak where lines are to be separated.  Do not use the LaTeX command '\\'.
%\begin{spacing}{2.0}
\ktitle{라그랑지안 기반 제약 강화학습을 이용한 자율주행에서의 상태별 안전성 보장}
%\end{spacing}
%-----------------------------------------------------------------------
...
\refereeA{Prof. UeHwan Kim.}
\refereeB{Prof. KyungJoong Kim.}
